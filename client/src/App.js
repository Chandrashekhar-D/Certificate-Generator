...
function App() {
 ...
 const [csvuploaded,setcsvuploaded]=useState('')
    ...
    /**To set the user-customized attributes of text*/
    const generate_certificate = ()=>{
      ...
      /**set the top of absolute text*/
      console.log("here is height ",parseInt(window.getComputedStyle(text).fontSize, 10))

      /**compensating the font-height difference in top since 'purified-image' considers the co-ordinates as bottom-left and not top-left to build the text*/
      setTop(parseFloat(text.style.top)+1.017*parseFloat(window.getComputedStyle(text).fontSize, 10))
      console.log("second done")
  
      /*** set the left of absolute text**/
      ...
      /**
       * checking the font selected and setting the font file name and font to send at backend
       **/
  ...
  // To post data to the sever using fetch API
    ...
    const uploadTemplate = async (e)=>{
      ...
      const response = await axios({
       ...
       useEffect(()=>{
        if(csvuploaded.includes('1') && csvuploaded.includes('2') && csvuploaded.includes('3') && csvuploaded.includes('4') ){
          // document.getElementById('sendmailbut').style.display="block"
          document.getElementById('sendmailbut').disabled=false
                    // document.getElementById('sendmailbut').ariaDisabled=false
      ...
      useEffect(()=>{
    //  document.querySelector('#sendmailbut').style.display="none"
  ...
  <div className="card-img-overlay">
    ...
    <div className="col-sm-5 " style={{marginRight:4.5+'rem'}}  id="outer" >
          <Carousel/>
        <div className="card" id="uploadcard" style={{width:100+'%'}}>
          ...
          <div id="side-panel">
            <div id="tools">
              ...
              <img onClick={openModal} height="36px" id="ado" class="btn btn-light"
    ...
    <div className="modal-content">
      ...
      <div id="down">
         ...
         <div className="flexit">
           ...
           <input id="upcsv" type="file" accept=".csv,.xlsx,.xls" name="csv" onChange={(e)=>{readCSV(e);setcsvuploaded(csvuploaded+'1');document.getElementById('progressbar').style.width="82%"}} />
       ...
       <input
             ...
             <input required id="password" type="password" placeholder="Enter your password" onChange={(e)=>{
            ...
            setcsvuploaded(csvuploaded+'4')}
             ...
             };document.getElementById('progressbar').style.width="99%"}}>Upload Template</button>
            <br/>
