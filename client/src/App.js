...
function Main() {
  ...
  const generate_certificate = () => {
    ...
    console.log(
      "here is height ",
      parseInt(window.getComputedStyle(text).fontSize, 10)
    );
    setTop(
              ...
              <div class="col-sm ml-2 mt-2 ">
                <div class="card  text-dark" style={{ border: 0 + "px" }}>
                  ...
                  <div class="card-img-overlay">
                    <p style={{ fontSize: 5 + "rem" }} class="card-title ">
                      <strong>Certificate</strong> Generation
                    </p>
                ...
                <div class="card" id="uploadcard" style={{ width: 100 + "%" }}>
                  <div class="card-body">
                    <h2
                      ...
                      id="uploadtitle"
                    >
                      <strong>Upload the certificate template</strong>
                    </h2>
                    <input
                      class="mt-5"
                      type="file"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-footer">
                <p style={{ marginRight: 12 + "rem" }}>
                  See the guidelines for more understanding
                </p>
                <button
                  type="button"
